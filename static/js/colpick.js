        ...
        var tpl =
            ...
            fillHSBFields = function (hsb, cal) {
                $(cal)
                    .data("colpick")
                    .fields.eq(4)
                    .val(Math.round(hsb.h * 10) / 10)
                    .end()
                    .eq(5)
                    .val(Math.round(hsb.s * 10) / 10)
                    .end()
                    .eq(6)
                    .val(Math.round(hsb.b * 10) / 10)
                    .end();
            },
            ...
            change = function (ev) {
                ...
                if (this.parentNode.className.indexOf("_hex") > 0) {
                    ...
                    cal.data("colpick").color = col = RGBToHSB(
                        fixRGB({
            ...
            downHue = function (ev) {
                ...
                change.apply(
                    current.cal
                        ...
                        .val(
                            parseInt(
                                (360 * (current.cal.data("colpick").height - (ev.pageY - current.y))) /
                                    current.cal.data("colpick").height,
                                10
                            )
                        )
                        .get(0),
                ...
                change.apply(
                    ev.data.cal
                        ...
                        .val(
                            parseInt(
                                (360 *
                                    (ev.data.cal.data("colpick").height -
                                        Math.max(
                                            0,
                                            Math.min(ev.data.cal.data("colpick").height, ev.pageY - ev.data.y)
                                        ))) /
                                    ev.data.cal.data("colpick").height,
                                10
                            )
            ...
            downSelector = function (ev) {
                ...
                change.apply(
                    current.cal
                        ...
                        .val(
                            parseInt(
                                (100 * (current.cal.data("colpick").height - (ev.pageY - current.pos.top))) /
                                    current.cal.data("colpick").height,
                                10
                            )
                        )
                        .end()
                        .eq(5)
                        .val(parseInt((100 * (ev.pageX - current.pos.left)) / current.cal.data("colpick").height, 10))
                        .get(0),
                    [current.preview]
                );
            },
                            ...
                            parseInt(
                                (100 *
                                    (ev.data.cal.data("colpick").height -
                                        Math.max(
                                            0,
                                            Math.min(ev.data.cal.data("colpick").height, ev.pageY - ev.data.pos.top)
                                        ))) /
                                    ev.data.cal.data("colpick").height,
                                10
                            )
                        ...
                        .val(
                            parseInt(
                                (100 *
                                    Math.max(
                                        0,
                                        Math.min(ev.data.cal.data("colpick").height, ev.pageX - ev.data.pos.left)
                                    )) /
                                    ev.data.cal.data("colpick").height,
                                10
                            )
            ...
            init: function (opt) {
                ...
                return this.each(function () {
                    ...
                    if (!$(this).data("colpickId")) {
                        ...
                        cal.addClass(
                            "colpick_" + options.layout + (options.submit ? "" : " colpick_" + options.layout + "_ns")
                        );
